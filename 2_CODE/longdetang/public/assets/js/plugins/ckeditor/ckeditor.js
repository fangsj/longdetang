...
(function () {
        ...
        return {
            define: function (b, d) {
                ...
                if (g.getListenerIndex(d) < 0) {
                    ...
                    j.fn = d;
                    j.priority = i;
                    for (var s = g.length - 1; s >= 0; s--)if (g[s].priority <= i) {
                        g.splice(s + 1, 0, j);
            ...
            once: function () {
                ...
                return function (i, j, n) {
                    var g = d(this)[i], i = a, B = f;
                    a = f = 0;
                    if (g) {
                        var s = g.listeners;
                        if (s.length)for (var s = s.slice(0), z, o = 0; o < s.length; o++) {
                            if (g.errorProof)try {
                                z =
                            ...
                            else z = s[o].call(this, n, j, b, h);
                            z === false ? f = 1 : typeof z != "undefined" && (j = z);
                            if (a || f)break
                        }
                    }
    ...
    CKEDITOR.tools.extend(CKEDITOR.dom.node.prototype, {
        appendTo: function (a, d) {
            ...
            for (var d = this.getAddress(), a = a.getAddress(),
                     b = Math.min(d.length, a.length), c = 0; c <= b - 1; c++)if (d[c] != a[c]) {
        ...
        CKEDITOR.tools.extend(CKEDITOR.dom.element.prototype,
            {
                ...
                if (!b.removeProperty && (a == "border" || a == "margin" || a == "padding")) {
                    ...
                    for (var b = [], d = 0; d < c.length; d++)if (g)for (var s = 0; s < g.length; s++)b.push([a, c[d], g[s]].join("-"));
                ...
                var b = 0,
                    c = 0, g = this.getDocument(), d = g.getBody(), s = g.$.compatMode == "BackCompat";
                if (document.documentElement.getBoundingClientRect) {
                    var e = this.$.getBoundingClientRect(), o = g.$.documentElement, p = o.clientTop || d.$.clientTop || 0, f = o.clientLeft || d.$.clientLeft || 0, h = true;
                    if (CKEDITOR.env.ie) {
                    ...
                    p = this;
                    for (f = null; p && !(p.getName() == "body" || p.getName() == "html");) {
                        b = b + (p.$.offsetLeft - p.$.scrollLeft);
                        c = c + (p.$.offsetTop - p.$.scrollTop);
                        if (!p.equals(this)) {
                            b = b + (p.$.clientLeft || 0);
                            c = c + (p.$.clientTop || 0)
                        }
                ...
                if (a) {
                    e = this.getWindow();
                    p = a.getWindow();
                    if (!e.equals(p) && e.$.frameElement) {
                        a = (new CKEDITOR.dom.element(e.$.frameElement)).getDocumentPosition(a);
                        b = b + a.x;
                        c = c + a.y
                    }
                }
                if (!document.documentElement.getBoundingClientRect && CKEDITOR.env.gecko && !s) {
                ...
                function p(a, b) {
                    ...
                    g = a.getWindow();
                    if (!g.equals(b)) {
                        g = p(CKEDITOR.dom.element.get(g.$.frameElement), b);
                        c.x = c.x + g.x;
                        c.y = c.y + g.y
                    }
                    return c
                ...
                (a = this.getWindow());
                e = a.getDocument();
                var x = e.$.compatMode == "BackCompat";
                a instanceof CKEDITOR.dom.window && (a = x ? e.getBody() : e.getDocumentElement());
                e = a.getWindow();
                d = p(this, e);
                var u = p(a, e), C = this.$.offsetHeight;
                g = this.$.offsetWidth;
                var l = a.$.clientHeight, q = a.$.clientWidth;
                e = d.x - h(this, "left") - u.x || 0;
                f = d.y - h(this, "top") - u.y || 0;
                g = d.x + g + h(this, "right") - (u.x + q) || 0;
                d = d.y + C + h(this, "bottom") - (u.y + l) || 0;
                ...
                for (var c = this.$.attributes, b = b || {}, g = 0; g < c.length; g++) {
                    ...
                    if (!(e in b))if (e == "checked" && (f = this.getAttribute(e))) a.setAttribute(e, f);
                ...
                return function (b) {
                    var c =
                        this.$;
                    if (b.slice)for (b = b.slice(); b.length > 0 && c;)c = a(c, b.shift());
                    else c = a(c, b);
    ...
    (function () {
        function a(a, b) {
            ...
            g = c.endContainer;
            var e = c.startOffset, f = c.endOffset, h, i = this.guard, l = this.type, q = a ? "getPreviousSourceNode" : "getNextSourceNode";
            ...
            if (a && !this._.guardRTL) {
                var F = d.type == CKEDITOR.NODE_ELEMENT ? d : d.getParent(), w = d.type == CKEDITOR.NODE_ELEMENT ? e ? d.getChild(e - 1) : null : d.getPrevious();
                this._.guardRTL = function (a, b) {
                    return (!b || !F.equals(a)) && (!w || !a.equals(w)) && (a.type != CKEDITOR.NODE_ELEMENT || !b || !a.equals(c.root))
                }
            }
            var H = a ? this._.guardRTL : this._.guardLTR;
            h = i ? function (a, b) {
                    return H(a, b) === false ? false : i(a, b)
                } : H;
            if (this.current) g = this.current[q](false, l, h);
            else {
                if (a) g.type ==
                CKEDITOR.NODE_ELEMENT && (g = f > 0 ? g.getChild(f - 1) : h(g, true) === false ? null : g.getPreviousSourceNode(true, l, h));
                else {
                    g = d;
    ...
    (function () {
        ...
        function d(a, b, c, d, o) {
            function e(a, b, c, g) {
                ...
                if (g && i)return k;
                if (l || g) b.append(a.clone(true, o), c);
                else {
                    a.remove();
                    n && b.append(a)
                }
            ...
            function f() {
                var a, b, c, g = Math.min(J.length, D.length);
                for (a = 0; a < g; a++) {
                    b = J[a];
                    c = D[a];
            ...
            function h() {
                var b = y - 1, c = A && K && !q.equals(k);
                if (b < v - 1 || b < L - 1 || c) {
                    c ? a.moveToPosition(k,
                            CKEDITOR.POSITION_BEFORE_START) : L == b + 1 && H ? a.moveToPosition(D[b], CKEDITOR.POSITION_BEFORE_END) : a.moveToPosition(D[b + 1], CKEDITOR.POSITION_BEFORE_START);
                    if (d)if ((b = J[b + 1]) && b.type == CKEDITOR.NODE_ELEMENT) {
            ...
            a.optimizeBookmark();
            var i = b === 0, n = b == 1, l = b == 2, b = l || n, q = a.startContainer, k = a.endContainer,
                m = a.startOffset, F = a.endOffset, w, H, A, K, E, r;
            if (l && k.type == CKEDITOR.NODE_TEXT && q.equals(k)) {
                q = a.document.createText(q.substring(m, F));
                c.append(q)
            }
            else {
                if (k.type == CKEDITOR.NODE_TEXT) l ? r = true : k = k.split(F);
                else if (k.getChildCount() > 0)if (F >= k.getChildCount()) {
                    k = k.getChild(F - 1);
                    H = true
                }
                else k = k.getChild(F);
                else K = H = true;
                if (q.type == CKEDITOR.NODE_TEXT) l ? E = true : q.split(m);
                else if (q.getChildCount() > 0)if (m === 0) {
                    q = q.getChild(m);
                    w = true
                }
                else q = q.getChild(m - 1);
                else A = w = true;
                for (var J = q.getParents(), D = k.getParents(),
                         y = f(), v = J.length - 1, L = D.length - 1, O = c, j, U, T, Z = -1, M = y; M <= v; M++) {
                    U = J[M];
                    T = U.getNext();
                    for (M == v && !(U.equals(D[M]) && v < L) ? w ? e(U, O, false, A) : E && O.append(a.document.createText(U.substring(m))) : b && (j = O.append(U.clone(0, o))); T;) {
                        if (T.equals(k)) {
                            Z = M;
                            break
                        }
                ...
                for (M = y; M <= L; M++) {
                    ...
                    T = c.getPrevious();
                    if (!c.equals(J[M])) {
                        M == L && !(c.equals(J[M]) && L < v) ? H ? e(c, O, false, K) : r && O.append(a.document.createText(c.substring(0, F))) : b && (j = O.append(c.clone(0, o)));
                        if (M > Z)for (; T;)T = e(T,
                            O, true);
                        O = j
                    }
            ...
            clone: function () {
                ...
                switch (a) {
                    ...
                    case CKEDITOR.ENLARGE_ELEMENT:
                        ...
                        var f = this.getCommonAncestor(), h = this.root, i, n, j, l, q, k = false, m, F;
                        m = this.startContainer;
                        var w = this.startOffset;
                        if (m.type == CKEDITOR.NODE_TEXT) {
                            if (w) {
                                m = !CKEDITOR.tools.trim(m.substring(0, w)).length && m;
                                k = !!m
                            }
                            if (m && !(l = m.getPrevious())) j = m.getParent()
                        }
                        else {
                            w && (l = m.getChild(w - 1) || m.getLast());
                            l || (j = m)
                        }
                        for (j = c(j); j || l;) {
                            if (j && !l) {
                            ...
                            for (; l;) {
                                ...
                                if (l.type == CKEDITOR.NODE_COMMENT) l = l.getPrevious();
                                    ...
                                    if (l.type == CKEDITOR.NODE_TEXT) {
                                        ...
                                        F = l.getText();
                                        if (d.test(F)) l = null;
                                        else for (var w = l.$.getElementsByTagName("*"), H = 0, A; A = w[H++];)if (!CKEDITOR.dtd.$removeEmpty[A.nodeName.toLowerCase()]) {
                                            l =
                                                null;
                                            break
                                        }
                                    ...
                                    m && (k ? q ? i = j : j && this.setStartBefore(j) : k = true);
                                    if (l) {
                                        m = l.getPrevious();
                                        if (!j && !m) {
                                            j = l;
                        ...
                        if (m.type == CKEDITOR.NODE_TEXT)if (CKEDITOR.tools.trim(m.substring(w)).length) k = true;
                        else {
                            k = !m.getLength();
                            if (w == m.getLength()) {
                                if (!(l = m.getNext())) j = m.getParent()
                            }
                            else K(m, w) && (j = m.getParent())
                        }
                        else(l = m.getChild(w)) || (j = m);
                        for (; j || l;) {
                            if (j && !l) {
                                !q && j.equals(f) && (q = true);
                                if (e ? j.isBlockBoundary() : !h.contains(j))break;
                                ...
                                if (l.type == CKEDITOR.NODE_TEXT) {
                                    ...
                                    if ((l.$.offsetWidth > 0 || b && l.is("br")) && !l.data("cke-bookmark"))if (k && CKEDITOR.dtd.$removeEmpty[l.getName()]) {
                                        ...
                                        if (d.test(F)) l = null;
                                            ...
                                            w = l.$.getElementsByTagName("*");
                                            for (H = 0; A = w[H++];)if (!CKEDITOR.dtd.$removeEmpty[A.nodeName.toLowerCase()]) {
                                                l = null;
                                                break
                                            }
                                        }
                    ...
                    case CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS:
                        ...
                        var E, r, J = CKEDITOR.dom.walker.blockBoundary(a == CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS ? {br: 1} : null), D = null, y = function (a) {
                            if (a.type ==
                                CKEDITOR.NODE_ELEMENT && a.getAttribute("contenteditable") == "false")if (D) {
                                if (D.equals(a)) {
                                    D = null;
                                    return
                                }
                ...
                if (!this.collapsed) {
                    ...
                    if (e && e.type == CKEDITOR.NODE_TEXT)if (h)if (h >= e.getLength()) d.setStartAfter(e);
                    else {
                        d.setStartBefore(e);
                        j = 0
                    }
                    else d.setStartBefore(e);
                    if (f && f.type == CKEDITOR.NODE_TEXT)if (i)if (i >= f.getLength()) d.setEndAfter(f);
                    else {
                        d.setEndAfter(f);
                        n = 0
                    }
                    ...
                    d.guard = function (b, d) {
                        if (l(b))return true;
                        if (a == CKEDITOR.SHRINK_ELEMENT && b.type == CKEDITOR.NODE_TEXT || d && b.equals(q) || c === false && b.type == CKEDITOR.NODE_ELEMENT && b.isBlockBoundary() || b.type == CKEDITOR.NODE_ELEMENT && b.hasAttribute("contenteditable"))return false;
        ...
        a.prototype = {
            getNextParagraph: function (a) {
                ...
                if (!this._.started) {
                    ...
                    h = p.startPath();
                    var t = p.endPath(), x = !p.collapsed && c(p, h.block), u = !p.collapsed && c(p, t.block, 1);
                    p.shrink(CKEDITOR.SHRINK_ELEMENT, true);
                    x && p.setStartAt(h.block, CKEDITOR.POSITION_BEFORE_END);
                    u && p.setEndAt(t.block, CKEDITOR.POSITION_AFTER_START);
                    h = p.endContainer.hasAscendant("pre", true) || p.startContainer.hasAscendant("pre", true);
                    p.enlarge(this.forceBrBreak && !h || !this.enlargeBr ? CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS :
                        CKEDITOR.ENLARGE_BLOCK_CONTENTS);
                    if (!p.collapsed) {
                        h = new CKEDITOR.dom.walker(p.clone());
                        ...
                        h.evaluator = t;
                        h = h.previous();
                        this._.lastNode = h.getNextSourceNode(true, null, p.root);
                        ...
                        if (!this._.lastNode || !p.root.contains(this._.lastNode)) {
                ...
                for (this._.nextNode = null; t;) {
                    var x = 0, u = t.hasAscendant("pre"), C = t.type != CKEDITOR.NODE_ELEMENT, l = 0;
                    if (C) t.type == CKEDITOR.NODE_TEXT && e.test(t.getText()) &&
                    (C = 0);
                    else {
                        var q = t.getName();
                        if (CKEDITOR.dtd.$block[q] && t.getAttribute("contenteditable") == "false") {
                            d = t;
                            b(this, a, d);
                            break
                        }
                        else if (t.isBlockBoundary(this.forceBrBreak && !u && {br: 1})) {
                            if (q == "br") C = 1;
                            else if (!h && !t.getChildCount() && q != "hr") {
                                d = t;
                                s = t.equals(p);
                                break
                            }
                    ...
                    s = (!x || C) && t.equals(p);
                    if (h && !x)for (; !t.getNext(i) && !s;) {
                        q = t.getParent();
                        if (q.isBlockBoundary(this.forceBrBreak && !u && {br: 1})) {
                            x = 1;
                            C = 0;
                            s || q.equals(p);
                    ...
                    C && h.setEndAt(t, CKEDITOR.POSITION_AFTER_END);
                    t = this._getNextSourceNode(t, l, p);
                    if ((s = !t) || x && h)break
                }
                if (!d) {
                    if (!h) {
                    ...
                    x = {div: 1, th: 1, td: 1};
                    d = d.block;
                    if (!d && t && !this.enforceRealBlocks && x[t.getName()] && h.checkStartOfBlock() && h.checkEndOfBlock() && !t.equals(h.root)) d = t;
                    else if (!d || this.enforceRealBlocks && d.is(j)) {
                ...
                if (z) (z = d.getPrevious()) && z.type == CKEDITOR.NODE_ELEMENT && (z.getName() == "br" ? z.remove() : z.getLast() && z.getLast().$.nodeName.toLowerCase() == "br" && z.getLast().remove());
                if (o) (z = d.getLast()) && z.type == CKEDITOR.NODE_ELEMENT && z.getName() == "br" && (!CKEDITOR.env.needsBrFiller || z.getPrevious(f) || z.getNext(f)) && z.remove();
                if (!this._.nextNode) this._.nextNode = s || d.equals(p) || !p ? null : this._getNextSourceNode(d,
                        1, p);
                return d
    ...
    (function () {
        function a(a, b, c, d, k) {
            ...
            for (e in b) {
                m = b[e];
                m = typeof m == "boolean" ? {} : typeof m == "function" ? {match: m} : K(m);
                ...
                for (v in D) {
                    f[v] = h(f[v], g) || null;
                    var w = f, r = y[v], o = h(f[y[v]], g), A = f[v], F = [], l = true, q = void 0;
                    o ? l = false : o = {};
                    for (q in A)if (q.charAt(0) == "!") {
                        q = q.slice(1);
                        F.push(q);
                        o[q] = true;
                        l = false
            ...
            for (var b = k.elements, k = k.generic, L, c = 0, d = a.length; c < d; ++c) {
                ...
                for (v in y) {
                    ...
                    o = [];
                    A = void 0;
                    for (A in r)A.indexOf("*") > -1 ? o.push(RegExp("^" + A.replace(/\*/g, ".*") + "$")) : o.push(A);
                    r = o;
                    if (r.length) {
                        f[g] = r;
                        w = false
                ...
                if (e.elements === true || e.elements === null) k[m ? "unshift" : "push"](e);
                else {
                    f = e.elements;
                    delete e.elements;
                    for (L in f)if (b[L]) b[L][m ? "unshift" : "push"](e);
                    else b[L] = [e]
                }
            }
        }
        ...
        function g(a) {
            for (var b, c, d, k, e = {}, m = 1, a = E(a); b = a.match(v);) {
                if (c = b[2]) {
                    d = B(c, "styles");
                    k = B(c, "attrs");
                    c = B(c, "classes")
        ...
        function z(a, b, k, e) {
            var m = 0, f;
            if (e.toHtml) b.name = b.name.replace(O, "$1");
            if (e.doCallbacks && a.elementCallbacks) {
                a:for (var g = a.elementCallbacks, v = 0, w = g.length, r; v < w; ++v)if (r = g[v](b)) {
                    f = r;
                    break a
                }
                if (f)return f
            ...
            if (e.doFilter) {
                a:{
                    ...
                    if (!a && !f) a = null;
                        ...
                        if (g) {
                            h = 0;
                            for (o = g.length; h < o; ++h)if (c(g[h], b, r) === false) {
                                a = null;
                                break a
                            }
                        }
                        if (v) {
                            h = 0;
                            for (o = v.length; h < o; ++h)c(v[h], b, r)
                        }
                        if (a) {
                            h = 0;
                            for (o = a.length; h <
                        ...
                        if (f) {
                            h = 0;
                            for (o = f.length; h < o; ++h)d(f[h], b, r, w)
                        }
                        a = r
                    }
                }
                ...
                var F = a.validStyles;
                f = a.validClasses;
                var g = b.attributes, l = b.styles, v = b.classes, w = b.classBackup, y = b.styleBackup, D, L, i = [];
                r = [];
                var H = /^data-cke-/;
                h = false;
                delete g.style;
                ...
                if (!a.allAttributes)for (D in g)if (!o[D])if (H.test(D)) {
                    if (D != (L = D.replace(/^data-cke-saved-/, "")) && !o[L]) {
                        delete g[D];
                        h = true
                    }
                }
                ...
                if (!a.allStyles || a.hadInvalidStyle) {
                    for (D in l)a.allStyles || F[D] ? i.push(D + ":" + l[D]) : h = true;
                    if (i.length) g.style = i.sort().join("; ")
                }
                else if (y) g.style = y;
                if (!a.allClasses || a.hadInvalidClass) {
                    for (D = 0; D < v.length; ++D)(a.allClasses || f[v[D]]) && r.push(v[D]);
                    r.length && (g["class"] = r.sort().join(" "));
                    w && r.length < w.split(/\s+/).length && (h = true)
                }
                else w && (g["class"] = w);
                h && (m = A);
        ...
        function C(a) {
            return a.type == CKEDITOR.NODE_ELEMENT && (a.name == "br" || H.$block[a.name])
        }

        function l(a, b, c) {
            var d = a.name;
            if (H.$empty[d] || !a.children.length)if (d == "hr" && b == "br") a.replaceWith(u());
            else {
                a.parent && c.push({check: "it", el: a.parent});
                a.remove()
            }
            else if (H.$block[d] || d == "tr")if (b == "br") {
                if (a.previous && !C(a.previous)) {
                    b = u();
                    b.insertBefore(a)
                }
                if (a.next && !C(a.next)) {
                ...
                if (k) {
                    ...
                    k = a.parent;
                    for (var e = k.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT || k.name == "body", g, v, m = d.length; m > 0;) {
                        f = d[--m];
                        if (e && (f.type == CKEDITOR.NODE_TEXT || f.type == CKEDITOR.NODE_ELEMENT && H.$inline[f.name])) {
                            if (!g) {
                            ...
                            v = H[k.name] || H.span;
                            f.insertAfter(a);
                            k.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT && (f.type == CKEDITOR.NODE_ELEMENT && !v[f.name]) && c.push({
                                check: "el-up",
                                el: f
                            })
                        }
        ...
        var H = CKEDITOR.dtd, A = 1, K = CKEDITOR.tools.copy, E = CKEDITOR.tools.trim, r = "cke-test", J = ["", "p", "br", "div"];
        ...
        CKEDITOR.filter = function (a) {
            ...
            if (a instanceof CKEDITOR.editor) {
                ...
                if (b === true) this.disabled = true;
                    ...
                    this.allow(J[a.enterMode] + " " + J[a.shiftEnterMode], "default", 1);
        ...
        CKEDITOR.filter.prototype = {
            allow: function (b, c, d) {
                ...
                var k = this, e = [], m = this.editor && this.editor.config.protectedSource, f, g = false, v = {
                    doFilter: !c,
                    doTransform: true,
                    doCallbacks: true,
                    toHtml: b
                ...
                a.forEach(function (a) {
                    if (a.type == CKEDITOR.NODE_ELEMENT) {
                        ...
                        a:{
                            ...
                            c = [];
                            var w, h, r;
                            if (m)for (h = 0; h < m.length; ++h)if ((r = d.match(m[h])) && r[0].length == d.length) {
                                c = true;
                                break a
                            }
                            d = CKEDITOR.htmlParser.fragment.fromHtml(d);
                            d.children.length == 1 && (w = d.children[0]).type == CKEDITOR.NODE_ELEMENT && z(k, w, c, v);
                            c = !c.length
                        }
                        c || e.push(a)
                    }
                ...
                e.length && (g = true);
                for (var w,
                         a = [], d = J[d || (this.editor ? this.editor.enterMode : CKEDITOR.ENTER_P)], h; c = e.pop();)c.type == CKEDITOR.NODE_ELEMENT ? l(c, d, a) : c.remove();
                for (; w = a.pop();) {
                    c = w.el;
                    if (c.parent) {
                        h = H[c.parent.name] || H.span;
                        switch (w.check) {
                            case "it":
                                H.$removeEmpty[c.name] && !c.children.length ? l(c, d, a) : t(c) || l(c, d, a);
                                break;
                            case "el-up":
                ...
                if (!this.disabled && a) {
                    ...
                    for (k = 0; k < a.length; ++k) {
                        b = a[k];
                        var e = void 0, m = void 0, f = void 0, g = void 0, v = void 0, h = void 0;
                        c = [];
                        for (m = 0; m < b.length; ++m) {
                            ...
                            v instanceof CKEDITOR.style && (v = F(v));
                            c.push({check: g == e ? null : g, left: v, right: typeof h == "string" ? w(h) : h})
                        }
                        b = e;
                        d[b] || (d[b] = []);
                        d[b].push(c)
            ...
            check: function (a, b, c) {
                ...
                var m = CKEDITOR.tools.clone(k), f = [], v;
                if (b !== false && (v = this._.transformations[k.name])) {
                    for (d = 0; d < v.length; ++d)q(this, k, v[d]);
                    p(k)
                }
                z(this, m, f, {doFilter: true, doTransform: b !== false, skipRequired: !c, skipFinalValidation: !c});
                b = f.length > 0 ? false :
        ...
        var D = {styles: 1, attributes: 1, classes: 1}, y = {
            styles: "requiredStyles",
            attributes: "requiredAttributes",
            classes: "requiredClasses"
        }, v = /^([a-z0-9\-*\s]+)((?:\s*\{[!\w\-,\s\*]+\}\s*|\s*\[[!\w\-,\s\*]+\]\s*|\s*\([!\w\-,\s\*]+\)\s*){0,3})(?:;\s*|$)/i, L = {
            styles: /{([^}]+)}/,
            attrs: /\[([^\]]+)\]/,
            classes: /\(([^\)]+)\)/
        }, O = /^cke:(object|embed|param)$/, aa = /^(object|embed|param)$/, U = CKEDITOR.filter.transformationsTools = {
            sizeToStyle: function (a) {
                ...
                if (!(c in a.attributes)) {
                    ...
                    k ? a.attributes[c] = k[1] : d == r && (a.attributes[c] = r)
                }
                delete a.styles[b]
        ...
        return function (b, c, e) {
            var f = {}, h = function (b) {
                a.call(this, b, function (a) {
                    ...
                    var b = [], g;
                    for (g in a) {
                        var i = a[g], s = i && i.requires;
                        if (!d[g]) {
                            if (i.icons)for (var z = i.icons.split(","), o = z.length; o--;)CKEDITOR.skin.addIcon(z[o], i.path + "icons/" + (CKEDITOR.env.hidpi && i.hidpi ? "hidpi/" : "") + z[o] + ".png");
                            d[g] = 1
                        }
                        if (s) {
                            s.split && (s = s.split(","));
                            for (i = 0; i < s.length; i++)f[s[i]] || b.push(s[i])
                        }
                    }
    ...
    (function () {
        ...
        function g(a) {
            ...
            CKEDITOR.plugins.load(c.split(","), function (c) {
                ...
                a.plugins = c;
                for (var h in c) {
                    var i = c[h], A = i.lang, j = null, E = i.requires, r;
                    CKEDITOR.tools.isArray(E) && (E = E.join(","));
                    if (E && (r = E.match(g)))for (; E = r.pop();)CKEDITOR.tools.setTimeout(function (a, b) {
                        throw Error('Plugin "' + a.replace(",", "") + '" cannot be removed from the plugins list, because it\'s required by "' +
                            b + '" plugin.');
                    }, 0, null, [E, h]);
                    if (A && !a.lang[h]) {
                        A.split && (A = A.split(","));
                        if (CKEDITOR.tools.indexOf(A, a.langCode) >= 0) j = a.langCode;
                        else {
                            j = a.langCode.replace(/-.*/, "");
                            j = j != a.langCode && CKEDITOR.tools.indexOf(A, j) >= 0 ? j : CKEDITOR.tools.indexOf(A, "en") >= 0 ? "en" : A[0]
                        }
                        if (!i.langEntries || !i.langEntries[j]) f.push(CKEDITOR.getUrl(i.path + "lang/" + j + ".js"));
                        else {
                            a.lang[h] = i.langEntries[j];
                            j = null
                        }
                    }
                    e.push(j);
                ...
                CKEDITOR.scriptLoader.load(f, function () {
                    for (var c = ["beforeInit", "init", "afterInit"], f = 0; f < c.length; f++)for (var g =
                        0; g < d.length; g++) {
                        var v = d[g];
                        f === 0 && (e[g] && v.lang && v.langEntries) && (a.lang[v.name] = v.langEntries[e[g]]);
                        if (v[c[f]]) v[c[f]](a)
                    }
            ...
            function (f, h, i) {
                function j(a) {
                    ...
                    if (t.length > 0)for (var c = 0; c < t.length; c++) {
                        var d = t[c], e = d.name, f = CKEDITOR.dtd[e], g = u.name && CKEDITOR.dtd[u.name];
                ...
                var o = new CKEDITOR.htmlParser, p = h instanceof CKEDITOR.htmlParser.element ? h : typeof h == "string" ? new CKEDITOR.htmlParser.element(h) : new CKEDITOR.htmlParser.fragment, t = [], x = [], u = p, C = p.name == "textarea", l = p.name == "pre";
                o.onTagOpen = function (e, k, f, g) {
                    ...
                    if (a(k)) t.push(k);
                        ...
                        if (e == "br") x.push(k);
                            ...
                            for (; ;) {
                                g = (f = u.name) ? CKEDITOR.dtd[f] || (u._.isBlockLike ? CKEDITOR.dtd.div : CKEDITOR.dtd.span) : c;
                                if (!k.isUnknown && !u.isUnknown && !g[e])if (u.isOptionalClose) o.onTagClose(f);
                                else if (e in b && f in b) {
                                    f = u.children;
                                    (f = f[f.length - 1]) && f.name == "li" || B(f = new CKEDITOR.htmlParser.element("li"), u);
                                    !k.returnPoint && (k.returnPoint = u);
                                    u = f
                                }
                                else if (e in CKEDITOR.dtd.$listItem && !z(e, f)) o.onTagOpen(e == "li" ? "ul" : "dl", {}, 0, 1);
                                else if (f in d && !z(e, f)) {
                                    !k.returnPoint && (k.returnPoint = u);
                                    u = u.parent
                                }
                                else {
                                    f in CKEDITOR.dtd.$inline && t.unshift(u);
                                    if (u.parent) B(u, u.parent, 1);
                                    else {
                                        k.isOrphan = 1;
                                        break
                                    }
                ...
                o.onText = function (a) {
                    if ((!u._.hasInlineStarted || x.length) && !l && !C) {
    ...
    (function () {
        ...
        a.prototype = {
            add: function (a, c, d) {
                ...
                var d = c instanceof CKEDITOR.htmlParser.node || c instanceof CKEDITOR.htmlParser.fragment, f = Array.prototype.slice.call(arguments, 1), h = this.rules, i = h.length, j, n, g, B;
                for (B = 0; B < i; B++) {
                    if (d) {
                        j = c.type;
                        n = c.name
    ...
    (function () {
        function a(a, d) {
            ...
            function g(a, d) {
                return function (e) {
                    if (e.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT) {
                        var g = [], v = b(e), r, h;
                        if (v)for (m(v, 1) && g.push(v); v;) {
                            if (f(v) && (r = c(v)) && m(r))if ((h = c(r)) && !f(h)) g.push(r);
                            else {
                                k(w).insertAfter(r);
                                r.remove()
                            }
                        ...
                        for (v = 0; v < g.length; v++)g[v].remove();
                        if (g = !a || (typeof d == "function" ? d(e) : d) !== false)if (!w && !CKEDITOR.env.needsBrFiller &&
                            e.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT) g = false;
                        else if (!w && !CKEDITOR.env.needsBrFiller && (document.documentMode > 7 || e.name in CKEDITOR.dtd.tr || e.name in CKEDITOR.dtd.$listItem)) g = false;
                        else {
                            g = b(e);
            ...
            function m(a, b) {
                if ((!w || CKEDITOR.env.needsBrFiller) && a.type == CKEDITOR.NODE_ELEMENT && a.name == "br" && !a.attributes["data-cke-eol"])return true;
                var c;
                if (a.type == CKEDITOR.NODE_TEXT && (c = a.value.match(t))) {
                    ...
                    if (!CKEDITOR.env.needsBrFiller && w && (!b || a.parent.name in A))return true;
                    if (!w)if ((c = a.previous) && c.name == "br" || !c || f(c))return true
                }
                return false
            }

            var r = {elements: {}}, w = d == "html", A = CKEDITOR.tools.extend({}, l), D;
            for (D in A)"#" in u[D] || delete A[D];
            for (D in A)r.elements[D] = g(w, a.config.fillEmptyBlocks);
            r.root = g(w, false);
        ...
        function n(a) {
            return a.replace(w, function (a, b, c) {
                return "<" + b + c.replace(H, function (a, b) {
        ...
        var t = /(?:&nbsp;|\xa0)$/, x = "{cke_protected}", u = CKEDITOR.dtd, C = ["caption", "colgroup", "col", "thead", "tfoot", "tbody"], l = CKEDITOR.tools.extend({}, u.$blockLimit, u.$block), q = {
                elements: {
                    input: i,
                    textarea: i
                }
                    ...
                    $: function (a) {
                        ...
                        a.children.slice(0).sort(function (a, b) {
                            ...
                            if (a.type == CKEDITOR.NODE_ELEMENT && b.type == a.type) {
                                c = CKEDITOR.tools.indexOf(C, a.name);
                                d = CKEDITOR.tools.indexOf(C, b.name)
                            }
                            if (!(c > -1 && d > -1 && c != d)) {
        ...
        var w = /<(a|area|img|input|source)\b([^>]*)>/gi, H = /([\w-:]+)\s*=\s*(?:(?:"[^"]*")|(?:'[^']*')|(?:[^ "'>]+))/gi, A = /^(href|src|name)$/i, K = /(?:<style(?=[ >])[^>]*>[\s\S]*?<\/style>)|(?:<(:?link|meta|base)[^>]*>)/gi, E = /(<textarea(?=[ >])[^>]*>)([\s\S]*?)(?:<\/textarea>)/gi,
    ...
    (function () {
        ...
        CKEDITOR.editable = CKEDITOR.tools.createClass({
            ...
            $: function (a, b) {
                ...
                restoreAttrs: function () {
                    ...
                    l(b);
                    var f, h;
                    if (g)for (; (f = b.getCommonAncestor(0, 1)) && (h = CKEDITOR.dtd[f.getName()]) && (!h || !h[e]);)if (f.getName() in CKEDITOR.dtd.span) b.splitElement(f);
                ...
                getData: function (a) {
                    ...
                    var c = q, d = {range: a, doc: a.document}, e = this.getHtmlFromRange(a);
                    if (a.collapsed) {
                        a.optimize();
                        return e
                    }
                    ...
                    if (b) {
                        c = a.startPath();
                        if (a.checkStartOfBlock() && a.checkEndOfBlock() && c.block && !a.root.equals(c.block)) {
                    ...
                    if (!this.is("textarea")) {
                        ...
                        this.attachListener(a, "key", function (b) {
                            ...
                            if (c in e) {
                                var b = a.getSelection(), g, f = b.getRanges()[0], h = f.startPath(), m, l, w, c = c == 8;
                                ...
                                else if (f.collapsed)if ((m = h.block) && (w =
                                        m[c ? "getPrevious" : "getNext"](o)) && w.type == CKEDITOR.NODE_ELEMENT && w.is("table") && f[c ? "checkStartOfBlock" : "checkEndOfBlock"]()) {
                                    a.fire("saveSnapshot");
                                    f[c ? "checkEndOfBlock" : "checkStartOfBlock"]() && m.remove();
                                    f["moveToElementEdit" + (c ? "End" : "Start")](w);
                                    f.select();
                                    a.fire("saveSnapshot");
                                    d = 1
                                }
                                else if (h.blockLimit && h.blockLimit.is("td") && (l = h.blockLimit.getAscendant("table")) && f.checkBoundaryOfElement(l, c ? CKEDITOR.START : CKEDITOR.END) && (w = l[c ? "getPrevious" : "getNext"](o))) {
                                    a.fire("saveSnapshot");
                                    f["moveToElementEdit" +
                                    (c ? "End" : "Start")](w);
                                    f.checkStartOfBlock() && f.checkEndOfBlock() ? w.remove() : f.select();
                                    a.fire("saveSnapshot");
                                    d = 1
                                }
                        ...
                        CKEDITOR.env.webkit && this.attachListener(a, "key", function (b) {
                            ...
                            if (b in e) {
                                var c =
                                    b == 8, d = a.getSelection().getRanges()[0], b = d.startPath();
                                if (d.collapsed) {
                                    var g;
                                    a:{
                                        var f = b.block;
                                        if (f)if (d[c ? "checkStartOfBlock" : "checkEndOfBlock"]())if (!d.moveToClosestEditablePosition(f, !c) || !d.collapsed) g = false;
                                        else {
        ...
        var o = CKEDITOR.dom.walker.whitespaces(true), p = CKEDITOR.dom.walker.bookmark(false, true), t = CKEDITOR.dom.walker.empty(), x = CKEDITOR.dom.walker.bogus(), u = /(^|<body\b[^>]*>)\s*<(p|div|address|h\d|center|pre)[^>]*>\s*(?:<br[^>]*>|&nbsp;|\u00A0|&#160;)?\s*(:?<\/\2>)?\s*(?=$|<\/body>)/gi, C = function () {
            ...
            function b(c, d) {
                var e, g, f, r, l = [], w = d.range.startContainer;
                e = d.range.startPath();
                for (var w = h[w.getName()], i = 0, j = c.getChildren(), q = j.count(), A = -1, J = -1, H = 0, F = e.contains(h.$list); i <
                q; ++i) {
                    e = j.getItem(i);
                    if (a(e)) {
                        f = e.getName();
                        if (F && f in CKEDITOR.dtd.$list) l = l.concat(b(e, d));
                        else {
                            r = !!w[f];
                            if (f == "br" && e.data("cke-eol") && (!i || i == q - 1)) {
                                H = (g = i ? l[i - 1].node : j.getItem(i + 1)) && (!a(g) || !g.is("br"));
                ...
                if (A > -1) l[A].firstNotAllowed = 1;
                if (J > -1) l[J].lastNotAllowed = 1;
                return l
            }

            function c(b,
                       d) {
                var e = [], g = b.getChildren(), f = g.count(), r, l = 0, m = h[d], w = !b.is(h.$inline) || b.is("br");
                for (w && e.push(" "); l < f; l++) {
                    r = g.getItem(l);
                    a(r) && !r.is(m) ? e = e.concat(c(r, d)) : e.push(r)
                }
                w && e.push(" ");
                return e
            }
            ...
            function e(b, c, d, g) {
                ...
                if ((h = (new CKEDITOR.dom.walker(f)).next()) && a(h) && l[h.getName()] && (r = h.getPrevious()) && a(r) && !r.getParent().equals(b.startContainer) && d.contains(r) &&
                    g.contains(h) && h.isIdentical(r)) {
                    h.moveChildren(r);
                    h.remove();
                    e(b, c, d, g)
                }
            ...
            delete j.br;
            return function (l, y, v, q) {
                var n = l.editor, o = false;
                if (y == "unfiltered_html") {
                    y = "html";
                    o = true
                }
                if (!q.checkReadOnly()) {
                    var E = (new CKEDITOR.dom.elementPath(q.startContainer, q.root)).blockLimit || q.root, l = {
                        type: y,
                        dontFilter: o,
                        editable: l,
                        editor: n,
                        ...
                        mergeCandidates: [],
                        zombies: []
                    }, y = l.range, q = l.mergeCandidates, s, p;
                    if (l.type == "text" && y.shrink(CKEDITOR.SHRINK_ELEMENT, true, false)) {
                        s = CKEDITOR.dom.element.createFromHtml("<span>&nbsp;</span>",
                            y.document);
                        y.insertNode(s);
                        y.setStartAfter(s)
                    }
                    o = new CKEDITOR.dom.elementPath(y.startContainer);
                    l.endPath = E = new CKEDITOR.dom.elementPath(y.endContainer);
                    if (!y.collapsed) {
                        var n = E.block || E.blockLimit, z = y.getCommonAncestor();
                        n && (!n.equals(z) && !n.contains(z) && y.checkEndOfBlock()) && l.zombies.push(n);
                        y.deleteContents()
                    }
                    for (; (p = a(y.startContainer) && y.startContainer.getChild(y.startOffset - 1)) && a(p) && p.isBlockBoundary() && o.contains(p);)y.moveToPosition(p, CKEDITOR.POSITION_BEFORE_END);
                    e(y, l.blockLimit, o, E);
                    if (s) {
                        y.setEndBefore(s);
                        y.collapse();
                        s.remove()
                    ...
                    s = y.startPath();
                    if (n = s.contains(d, false, 1)) {
                        y.splitElement(n);
                        l.inlineStylesRoot = n;
                        l.inlineStylesPeak = s.lastElement
                    }
                    s = y.createBookmark();
                    (n = s.startNode.getPrevious(i)) && a(n) && d(n) && q.push(n);
                    (n = s.startNode.getNext(i)) && a(n) && d(n) && q.push(n);
                    for (n = s.startNode; (n = n.getParent()) && d(n);)q.push(n);
                    y.moveToBookmark(s);
                    if (s = v) {
                        s = l.range;
                        if (l.type == "text" && l.inlineStylesRoot) {
                            p = l.inlineStylesPeak;
                            y = p.getDocument().createText("{cke-peak}");
                            for (q = l.inlineStylesRoot.getParent(); !p.equals(q);) {
                                y =
                                    y.appendTo(p.clone());
                                p = p.getParent()
                            }
                        ...
                        p = l.blockLimit.getName();
                        if (/^\s+|\s+$/.test(v) && "span" in CKEDITOR.dtd[p])var u = '<span data-cke-marker="1">&nbsp;</span>', v = u + v + u;
                        v = l.editor.dataProcessor.toHtml(v, {
                            context: null,
                            fixForBody: false,
                        ...
                        p = s.document.createElement("body");
                        p.setHtml(v);
                        if (u) {
                            p.getFirst().remove();
                            p.getLast().remove()
                        }
                        if ((u = s.startPath().block) && !(u.getChildCount() == 1 && u.getBogus()))a:{
                            var t;
                            if (p.getChildCount() == 1 && a(t = p.getFirst()) && t.is(r) && !t.hasAttribute("contenteditable")) {
                                u = t.getElementsByTag("*");
                                s = 0;
                                for (q = u.count(); s < q; s++) {
                                    y = u.getItem(s);
                                    if (!y.is(j))break a
                    ...
                    if (s) {
                        ...
                        var G;
                        p = l.blockLimit;
                        var q = 0, I, u = [], x, C, v = n = 0, N, V, y = t.startContainer, o = l.endPath.elements[0], W, E = o.getPosition(y), z = !!o.getCommonAncestor(y) && E != CKEDITOR.POSITION_IDENTICAL && !(E & CKEDITOR.POSITION_CONTAINS +
                            CKEDITOR.POSITION_IS_CONTAINED), y = b(l.dataWrapper, l);
                        for (f(y, t); q < y.length; q++) {
                            E = y[q];
                            if (G = E.isLineBreak) {
                                G = t;
                                N = p;
                                var Q = void 0, S = void 0;
                                if (E.hasBlockSibling) G = 1;
                                else {
                                    Q = G.startContainer.getAscendant(h.$block, 1);
                                    if (!Q || !Q.is({div: 1, p: 1})) G = 0;
                                    else {
                                        S = Q.getPosition(N);
                                        if (S == CKEDITOR.POSITION_IDENTICAL || S == CKEDITOR.POSITION_CONTAINS) G = 0;
                                        else {
                                            N = G.splitElement(Q);
                            ...
                            if (G) v = q > 0;
                                ...
                                G = t.startPath();
                                if (!E.isBlock && g(l.editor, G.block, G.blockLimit) && (C = B(l.editor))) {
                                    C =
                                        s.createElement(C);
                                    C.appendBogus();
                                    t.insertNode(C);
                                    CKEDITOR.env.needsBrFiller && (I = C.getBogus()) && I.remove();
                                    t.moveToPosition(C, CKEDITOR.POSITION_BEFORE_END)
                                }
                                if ((G = t.startPath().block) && !G.equals(x)) {
                                    if (I = G.getBogus()) {
                                        I.remove();
                                        u.push(G)
                                    }
                                ...
                                if (n && E.isElement) {
                                    G = t.startContainer;
                                    for (N = null; G && !h[G.getName()][E.name];) {
                                        if (G.equals(p)) {
                                            G = null;
                                            break
                                        }
                                    ...
                                    if (G) {
                                        ...
                                        G = q == y.length -
                                            1;
                                        N = c(E.node, N);
                                        for (var Q = [], S = N.length, R = 0, P = void 0, X = 0, $ = -1; R < S; R++) {
                                            P = N[R];
                                            if (P == " ") {
                                                if (!X && (!W || R)) {
                                ...
                                if (W) {
                                    for (; G = W.pop();)t.insertNode(G);
                                    W = 0
                                }
                                else t.insertNode(E.node);
                                if (E.lastNotAllowed && q < y.length - 1) {
                                    (V = z ? o : V) && t.setEndAt(V, CKEDITOR.POSITION_AFTER_START);
                                    n = 0
                                }
                                t.collapse()
                            }
                        }
                        if (y.length != 1) I = false;
                        else {
                            I = y[0];
                            I = I.isElement && I.node.getAttribute("contenteditable") == "false"
                        }
                        if (I) {
                            v = true;
                            G = y[0].node;
                            t.setStartAt(G, CKEDITOR.POSITION_BEFORE_START);
                            t.setEndAt(G, CKEDITOR.POSITION_AFTER_END)
                        }
                        l.dontMoveCaret = v;
                        l.bogusNeededBlocks = u
                    }
                    I = l.range;
                    var Y;
                    V = l.bogusNeededBlocks;
                    for (W = I.createBookmark(); x = l.zombies.pop();)if (x.getParent()) {
                        C = I.clone();
                        C.moveToElementEditStart(x);
                        C.removeEmptyBlocksAtEnd()
                    }
                    if (V)for (; x = V.pop();)CKEDITOR.env.needsBrFiller ? x.appendBogus() : x.append(I.document.createText(" "));
                    for (; x = l.mergeCandidates.pop();)x.mergeSiblings();
                    I.moveToBookmark(W);
                    if (!l.dontMoveCaret) {
                        for (x = a(I.startContainer) &&
                            I.startContainer.getChild(I.startOffset - 1); x && a(x) && !x.is(h.$empty);) {
                            if (x.isBlockBoundary()) I.moveToPosition(x, CKEDITOR.POSITION_BEFORE_END);
                            else {
                                if (d(x) && x.getHtml().match(/(\s|&nbsp;)$/g)) {
                                    Y = null;
                                    break
                                }
                                Y = I.clone();
                                Y.moveToPosition(x, CKEDITOR.POSITION_BEFORE_END)
                            }
                            x = x.getLast(i)
                        }
                        Y && I.moveToRange(Y)
        ...
        a = {
            detect: function (a, b) {
                var c = a.range, d = c.clone(), e = c.clone(), g = new CKEDITOR.dom.elementPath(c.startContainer,
                    b), f = new CKEDITOR.dom.elementPath(c.endContainer, b);
                d.collapse(1);
                e.collapse();
        ...
        d = {
            exclude: function (a) {
                ...
                (b = b.endNode) && (x(b) && (!c || !c.equals(b))) && a.range.setEndBefore(b)
            }
        };
        c = {
            ...
            return {
                list: {
                    detectMerge: function (a, b) {
                        var d = c(b,
                            a.bookmark), e = d.startPath(), g = d.endPath(), f = e.contains(CKEDITOR.dtd.$list), h = g.contains(CKEDITOR.dtd.$list);
                        ...
                        if (a.mergeListBookmark) {
                            ...
                            if (a.mergeList) {
                                var h = g.contains(CKEDITOR.dtd.$list), k = f.contains(CKEDITOR.dtd.$list);
                                if (!h.equals(k)) {
                                    k.moveChildren(h);
                                    k.remove()
                                }
                    ...
                    return {
                        detectPurge: function (a) {
                            ...
                            if (e > 1) {
                                ...
                                if (c && g && b.checkBoundaryOfElement(c,
                                        CKEDITOR.START) && b.checkBoundaryOfElement(g, CKEDITOR.END)) {
                                    b = a.range.clone();
                                    b.setStartBefore(c);
                                    b.setEndAfter(g);
                    ...
                    var c = b.startPath(), d;
                    if (g(a, c.block, c.blockLimit) && (d = B(a))) {
    ...
    (function () {
        ...
        function c(a) {
            return p(a) || a.type == CKEDITOR.NODE_ELEMENT && !a.is(CKEDITOR.dtd.$empty) ? true : false
        }
        ...
        CKEDITOR.on("instanceCreated", function (b) {
            ...
            e.on("contentDom", function () {
                ...
                var g = e.document, f = CKEDITOR.document, l = e.editable(), i = g.getBody(), j = g.getDocumentElement(), r = l.isInline(), q, D;
                CKEDITOR.env.gecko && l.attachListener(l, "focus", function (a) {
                    a.removeListener();
                    if (q !== 0)if ((a = e.getSelection().getNative()) && a.isCollapsed && a.anchorNode == l.$) {
                        a = e.createRange();
                ...
                l.attachListener(l, CKEDITOR.env.webkit ?
                    ...
                    q && CKEDITOR.env.webkit && (q = e._.previousActive && e._.previousActive.equals(g.getActive()));
                    e.unlockSelection(q);
                    q = 0
                }, null, null, -1);
                ...
                if (CKEDITOR.env.ie || r) {
                    x ? l.attachListener(l, "beforedeactivate", b, null, null, -1) : l.attachListener(e, "selectionCheck", b, null, null, -1);
                ...
                if (CKEDITOR.env.ie && !r) {
                    ...
                    l.attachListener(l, "mousedown", function (a) {
                        if (a.data.$.button == 2) {
                            ...
                            if (!a || a.getType() == CKEDITOR.SELECTION_NONE) y = e.window.getScrollPosition()
                        }
                    });
                    l.attachListener(l, "mouseup", function (a) {
                        if (a.data.$.button == 2 && y) {
                            e.document.$.documentElement.scrollLeft = y.x;
                            e.document.$.documentElement.scrollTop = y.y
                        }
                        y = null
                    });
                ...
                l.attachListener(l, "keydown", B(e), null, null, -1)
            });
        ...
        var x = typeof window.getSelection != "function", u = 1;
        ...
        CKEDITOR.dom.selection.prototype =
            {
                getNative: function () {
                    return this._.cache.nativeSel !== void 0 ? this._.cache.nativeSel : this._.cache.nativeSel = x ? this.document.$.selection : this.document.getWindow().$.getSelection()
                }, getType: x ? function () {
                    var a = this._.cache;
                    ...
                    if (!c || !c.rangeCount) b = CKEDITOR.SELECTION_NONE;
                        ...
                        if (d == c.endContainer && d.nodeType == 1 && c.endOffset - c.startOffset == 1 && C[d.childNodes[c.startOffset].nodeName.toLowerCase()]) b = CKEDITOR.SELECTION_ELEMENT
                    }
                    return a.type = b
                }, getRanges: function () {
                var a = x ? function () {
                        ...
                        var b = function (b, c) {
                            ...
                            for (var e = d.children, g, f, h = b.duplicate(), r = 0, l = e.length - 1, k = -1, i, j; r <= l;) {
                                k = Math.floor((r + l) / 2);
                                g = e[k];
                            ...
                            if (k == -1 || k == e.length - 1 && i < 0) {
                                ...
                                return {container: j, offset: -h}
                            }
                            h.collapse(i > 0 ? true : false);
                            h.setEndPoint(i > 0 ? "StartToStart" : "EndToStart", b);
                            h = h.text.replace(/(\r\n|\r)/g, "\n").length;
                            if (!h)return {container: d, offset: a(g) + (i > 0 ? 0 : 1)};
                            for (; h > 0;)try {
                                f = g[i > 0 ? "previousSibling" : "nextSibling"];
                                if (f.nodeType == CKEDITOR.NODE_TEXT) {
                                    h = h - f.nodeValue.length;
                                    j = f
                                }
                ...
                var b = this.getNative(), b = x ? b.type == "Control" ? "" : b.createRange().text : b.toString();
                ...
                if (a.length)if (this.isLocked) {
                    ...
                    if (f) this.fake(f);
                        ...
                        if (x) {
                            ...
                            f = a[0];
                            var a = f.collapsed, n, o, r;
                            if ((c = f.getEnclosedNode()) && c.type == CKEDITOR.NODE_ELEMENT && c.getName() in C && (!c.is("a") || !c.getText()))try {
                            ...
                            b = r.startNode;
                            if (!a) g = r.endNode;
                            r = f.document.$.body.createTextRange();
    ...
    (function () {
        ...
        function d(b) {
            ...
            if (b.collapsed) {
                ...
                b.trim();
                var l = b.createBookmark(), n = l.startNode, o = l.endNode, m = n, s;
                if (!i) {
                    var p = b.getCommonAncestor(), i = a(n, p), p = a(o, p);
                ...
                for (m.getPosition(o) == CKEDITOR.POSITION_FOLLOWING && (m = 0); m;) {
                    ...
                    if (m.equals(o)) {
                        ...
                        var q = m.type == CKEDITOR.NODE_ELEMENT ? m.getName() : null, p = q && m.getAttribute("contentEditable") == "false", u = q && m.getAttribute("data-nostyle");
                        if (q && m.data("cke-bookmark")) {
                            m =
                                m.getNextSourceNode(true);
                            continue
                        }
                        if (p && j && CKEDITOR.dtd.$block[q])for (var w = m, B = c(w), x = void 0, A = B.length, C = 0, w = A && new CKEDITOR.dom.range(w.getDocument()); C < A; ++C) {
                            var x = B[C], F = CKEDITOR.filter.instances[x.data("cke-filter")];
                            if (F ? F.check(this) : 1) {
                                w.selectNodeContents(x);
                                d.call(this, w)
                            }
                        }
                        B = q ? !k[q] || u ? 0 : p && !j ? 0 : (m.getPosition(o) | K) == K && (!f.childRule || f.childRule(m)) : 1;
                        if (B)if ((B = m.getParent()) && ((B.getDtd() || CKEDITOR.dtd.span)[g] || h) && (!f.parentRule || f.parentRule(B))) {
                            ...
                            q = m.type;
                            if (q == CKEDITOR.NODE_TEXT || p || q == CKEDITOR.NODE_ELEMENT && !m.getChildCount()) {
                                for (var q = m, S; (i = !q.getNext(H)) && (S = q.getParent(), k[S.getName()]) && (S.getPosition(n) | E) == E && (!f.childRule || f.childRule(S));)q = S;
                                s.setEndAfter(q)
                            }
                        }
                        else i = true;
                        else i = true;
                        m = m.getNextSourceNode(u || p)
                    }
                    if (i && s && !s.collapsed) {
                        for (var i = t(this, e), p = i.hasAttributes(), u = s.getCommonAncestor(), q = {}, B = {}, x = {}, A = {}, R, P, X; i && u;) {
                            if (u.getName() == g) {
                                for (R in f.attributes)if (!A[R] &&
                                    (X = u.getAttribute(P))) i.getAttribute(R) == X ? B[R] = 1 : A[R] = 1;
                                for (P in f.styles)if (!x[P] && (X = u.getStyle(P))) i.getStyle(P) == X ? q[P] = 1 : x[P] = 1
                            }
                            u = u.getParent()
                        }
                        for (R in B)i.removeAttribute(R);
                        for (P in q)i.removeStyle(P);
                        p && !i.hasAttributes() && (i = null);
                        if (i) {
                            s.extractContents().appendTo(i);
                            s.insertNode(i);
                            z.call(this, i);
                            i.mergeSiblings();
            ...
            if (a.collapsed) {
                for (var e = new CKEDITOR.dom.elementPath(d.getParent(), a.root), g, f = 0, h; f < e.elements.length && (h = e.elements[f]); f++) {
                    ...
                    if (this.checkElementRemovable(h)) {
                        ...
                        if (a.collapsed && (a.checkBoundaryOfElement(h, CKEDITOR.END) || (i = a.checkBoundaryOfElement(h, CKEDITOR.START)))) {
                            ...
                            h.mergeSiblings();
                            h.is(this.element) ? s.call(this, h) : o(h, C(this)[h.getName()])
                        }
                    }
                }
                if (g) {
                ...
                for (e = d; !e.equals(j);) {
                    ...
                    if (e.type == CKEDITOR.NODE_ELEMENT && this.checkElementRemovable(e)) {
                        e.getName() == this.element ? s.call(this, e) : o(e, C(this)[e.getName()]);
        ...
        function j(a, b) {
            ...
            else f ? b = B(c ? [a.getHtml()] : n(a), b) : a.moveChildren(b);
            b.replace(a);
            if (d) {
                var c = b, i;
                if ((i = c.getPrevious(A)) && i.type == CKEDITOR.NODE_ELEMENT && i.is("pre")) {
                    d = g(i.getHtml(), /\n$/, "") + "\n\n" + g(c.getHtml(), /^\n/, "");
        ...
        function s(a, b) {
            var c = this._.definition,
                d = c.attributes, c = c.styles, e = C(this)[a.getName()], g = CKEDITOR.tools.isEmpty(d) && CKEDITOR.tools.isEmpty(c), f;
        ...
        function z(a) {
            for (var b = C(this), c = a.getElementsByTag(this.element), d, e = c.count(); --e >= 0;) {
                d = c.getItem(e);
        ...
        var k = {
        ...
        }, m =
            {
                ...
                audio: 1,
                video: 1
            }, F = /\s*(?:;\s*|$)/, w = /#\((.+?)\)/g, H = CKEDITOR.dom.walker.bookmark(0, 1), A = CKEDITOR.dom.walker.whitespaces(1);
                    ...
                    if (!(4 > arguments.length)) {
                        ...
                        CKEDITOR.ui.dialog.uiElement.call(this, b, a, d, "div", null, e, function () {
                            ...
                            if (a.labelLayout != "horizontal") e.push('<label class="cke_dialog_ui_labeled_label' + g + '" ', ' id="' + c.labelId + '"', c.inputId ? ' for="' + c.inputId + '"' : "", (a.labelStyle ? ' style="' + a.labelStyle + '"' : "") + ">", a.label, "</label>", '<div class="cke_dialog_ui_labeled_content"', a.controlStyle ? ' style="' +
                                a.controlStyle + '"' : "", ' role="presentation">', f.call(this, b, a), "</div>");
                            else {
                                g = {
                                    type: "hbox",
                                    widths: a.widths,
            ...
            CKEDITOR.ui.dialog.radio.prototype = CKEDITOR.tools.extend(new CKEDITOR.ui.dialog.uiElement, {
                setValue: function (b, a) {
                    ...
                    onChange: function (b, a) {
                        ...
                        else return o.onChange.apply(this,
                            arguments);
                        return null
                    }
                }
    ...
    (function () {
        ...
        function V(a) {
            ...
            function e(d) {
                ...
                if (f == CKEDITOR.DIALOG_RESIZE_HEIGHT ||
                    f == CKEDITOR.DIALOG_RESIZE_BOTH) C = Math.max(g.minHeight || 0, n - l);
                a.resize(j, C);
                a._.moved || a.layout();
        ...
        CKEDITOR.dialog = function (a, b) {
            ...
            function d(b) {
                if (k == CKEDITOR.dialog._.currentTop) {
                    ...
                    o = j = 0;
                    if (9 == c || c == CKEDITOR.SHIFT + 9) e(c == CKEDITOR.SHIFT + 9 ? -1 : 1), o = 1;
                    else if (c == CKEDITOR.ALT + 121 && !k._.tabBarMode && 1 < k.getPageCount()) k._.tabBarMode = !0, k._.tabs[k._.currentTabId][0].focus(), k._.currentFocusIndex = -1, o = 1;
                    else if (-1 != CKEDITOR.tools.indexOf(f,
                            c) && k._.tabBarMode) c = -1 != CKEDITOR.tools.indexOf([d ? 39 : 37, 38], c) ? t.call(k) : w.call(k), k.selectPage(c), k._.tabs[c][0].focus(), o = 1;
                    else if ((13 == c || 32 == c) && k._.tabBarMode) this.selectPage(this._.currentTabId), this._.tabBarMode = !1, this._.currentFocusIndex = -1, e(1), o = 1;
                    else if (13 == c) {
                        c = b.data.getTarget();
                        ...
                        j = 1
                            ...
                            0, c) : !1 !== this.fire("cancel", {hide: !0}).hide && this.hide(), j = 1;
                    else return;
                    g(b)
                }
            }
        ...
        CKEDITOR.dialog.prototype = {
            ...
            setState: function (a) {
                this.state != a && (this.state = a, a == CKEDITOR.DIALOG_STATE_BUSY ? (this.parts.spinner || (this.parts.spinner = CKEDITOR.document.createElement("div", {
                        attributes: {"class": "cke_dialog_spinner"},
                        styles: {"float": "left", "margin-right": "8px"}
                    }), this.parts.spinner.setHtml("&#8987;"), this.parts.spinner.appendTo(this.parts.title, 1)), this.parts.spinner.show(), this.getButton("ok").disable()) : a == CKEDITOR.DIALOG_STATE_IDLE && (this.parts.spinner && this.parts.spinner.hide(), this.getButton("ok").enable()),
                    this.fire("state", a))
            }
        };
            ...
            add: function (a, b) {
                ...
                var a = function (a, c) {
                    ...
                    return CKEDITOR.tools.extend({
                        ...
                        "class": "cke_dialog_ui_button_ok", onClick: function (a) {
                            a = a.data.dialog;
        ...
        var F, v = {},
            q, s = {}, M = function (a) {
                ...
                var b = a.data.$.ctrlKey || a.data.$.metaKey, c = a.data.$.altKey, e = a.data.$.shiftKey, d = String.fromCharCode(a.data.$.keyCode);
                if ((b = s[(b ? "CTRL+" : "") + (c ? "ALT+" : "") + (e ? "SHIFT+" : "") + d]) && b.length) b =
            ...
            CKEDITOR.ui.dialog = {
                uiElement: function (a,
                    ...
                    if (!(4 > arguments.length)) {
                        ...
                        for (var k = i["class"] && i["class"].split ? i["class"].split(" ") :
                            [], j = 0; j < k.length; j++)k[j] && (n[k[j]] = 1);
                        k = [];
                        for (j in n)k.push(j);
                        i["class"] = k.join(" ");
    ...
    (function () {
        ...
        function v(b) {
            function a() {
                ...
                a.on(p, function (b) {
                    (!CKEDITOR.env.ie || !m) && l(b)
                });
                CKEDITOR.env.ie && a.on("paste", function (a) {
                    r || (e(), a.data.preventDefault(), l(a), g("paste") || b.openDialog("paste"))
                });
                CKEDITOR.env.ie && (a.on("contextmenu", f, null, null, 0), a.on("beforepaste", function (b) {
                    b.data && (!b.data.$.ctrlKey && !b.data.$.shiftKey) && f()
                }, null, null, 0));
                ...
                return {
                    canUndo: !1, async: !0, exec: function (b, a) {
                        ...
                        "string" == typeof a ? d({
                                dataValue: a,
                                method: "paste",
                                dataTransfer: o.initPasteDataTransfer()
            ...
            function i(a, d) {
                ...
                if (!c.getById("cke_pastebin")) {
                    ...
                    CKEDITOR.env.webkit ? (e.append(j), j.addClass("cke_editable"), e.is("body") || (k = "static" != e.getComputedStyle("position") ? e : CKEDITOR.dom.element.get(e.$.offsetParent), k = k.getDocumentPosition().y)) : e.getAscendant(CKEDITOR.env.ie ? "body" : "html", 1).append(j);
                    j.setStyles({
                        position: "absolute",
                    ...
                    (k = j.getParent().isReadOnly()) ? (j.setOpacity(0), j.setAttribute("contenteditable", !0)) : j.setStyle("ltr" == b.config.contentsLangDirection ? "left" : "right", "-1000px");
                    b.on("selectionChange", f, null, null, 0);
                    if (CKEDITOR.env.webkit || CKEDITOR.env.gecko) l = e.once("blur", f, null, null, -100);
                    k && j.focus();
                    k = new CKEDITOR.dom.range(j);
            ...
            function s() {
                ...
                a.lock();
                if (b.editable().fire(p) && !g("paste"))return a.unlock(), !1;
                a.unlock();
                return !0
            }
            ...
            function l(a) {
                var d = {type: "auto", method: "paste", dataTransfer: o.initPasteDataTransfer(a)},
                    c = !CKEDITOR.env.ie && !CKEDITOR.env.safari, e = d.dataTransfer.getTransferType(b) === CKEDITOR.DATA_TRANSFER_EXTERNAL;
                d.dataTransfer.cacheData();
                var f = !1 !== b.fire("beforePaste", d);
                f && (c || !e) && !d.dataTransfer.isEmpty() ? (a.data.preventDefault(), setTimeout(function () {
                        q(b, d)
                    }, 0)) : i(a, function (a) {
            ...
            function n(a) {
                if (u && a in {paste: 1, cut: 1})return CKEDITOR.TRISTATE_DISABLED;
            ...
            var o = CKEDITOR.plugins.clipboard, m = 0, r = 0, u = 0, p = CKEDITOR.env.ie ? "beforepaste" : "paste";
            (function () {
                b.on("key", t);
                b.on("contentDom", a);
                b.on("selectionChange", function (a) {
                    u =
                        a.data.selection.getRanges()[0].checkReadOnly();
                    k()
                });
            ...
            b.getClipboardData = function (a, d) {
                ...
                !1 === s() && (b.removeListener("paste", c), l && b.fire("pasteDialog", f) ? (b.on("pasteDialogCommit", e), b.on("dialogHide",
                        function (a) {
                            a.removeListener();
        ...
        function z() {
            ...
            return {
                get: function (d) {
                    if ("plain-text" ==
                        d)return a || (a = new CKEDITOR.filter("br"));
        ...
        function A(b) {
            ...
            b.on("contentDom", function () {
                ...
                var h = b.editable(), i = CKEDITOR.plugins.clipboard.getDropTarget(b), s = b.ui.space("top"), t = b.ui.space("bottom");
                s && s.on("dragover", c);
                t && t.on("dragover", c);
                h.attachListener(i, "dragstart",
                    f);
                h.attachListener(b, "dragstart", a.resetDragDataTransfer, a, null, 1);
                h.attachListener(b, "dragstart", function (d) {
                    a.initDragDataTransfer(d, b);
                    if ((a.dragRange = b.getSelection().getRanges()[0]) && CKEDITOR.env.ie && 10 > CKEDITOR.env.version) a.dragStartContainerChildCount = g(a.dragRange.startContainer), a.dragEndContainerChildCount = g(a.dragRange.endContainer)
                }, null, null, 2);
                h.attachListener(i, "dragend", f);
                h.attachListener(b, "dragend", a.initDragDataTransfer, a, null, 1);
                h.attachListener(b, "dragend", a.resetDragDataTransfer,
                    a, null, 100);
                h.attachListener(i, "dragover", function (a) {
                    var b = a.data.getTarget();
                ...
                h.attachListener(i, "drop", function (d) {
                    d.data.preventDefault();
                    var c = d.data.getTarget();
                    if (!c.isReadOnly() || c.type == CKEDITOR.NODE_ELEMENT && c.is("html")) {
                        var c = a.getRangeAtDropPosition(d, b), e = a.dragRange;
                        c && f(d, e, c)
                    }
                });
                h.attachListener(b, "drop",
                    a.initDragDataTransfer, a, null, 1);
                h.attachListener(b, "drop", function (c) {
                    if (c = c.data) {
                        var f = c.dropRange, g = c.dragRange, h = c.dataTransfer;
                        h.getTransferType(b) == CKEDITOR.DATA_TRANSFER_INTERNAL ? setTimeout(function () {
                                a.internalDrop(g, f, h, b)
                            }, 0) : h.getTransferType(b) == CKEDITOR.DATA_TRANSFER_CROSS_EDITORS ? d(g, f, h) : e(f, h)
                    }
                }, null, null, 9999)
            })
        }
        ...
        CKEDITOR.plugins.add("clipboard", {
            requires: "dialog", init: function (b) {
                var a, c = z();
                b.config.forcePasteAsPlainText ? a = "plain-text" : b.config.pasteFilter ? a = b.config.pasteFilter :
                        CKEDITOR.env.webkit && !("pasteFilter" in b.config) && (a = "semantic-content");
                ...
                b.on("paste", function (a) {
                    ...
                    if (!a.data.dataValue) {
                        var c = a.data.dataTransfer, f = c.getData("text/html");
                        if (f) a.data.dataValue = f, a.data.type = "html";
                        else if (f = c.getData("text/plain")) a.data.dataValue = b.editable().transformPlainTextToHtml(f),
                            a.data.type = "text"
                    }
                }, null, null, 1);
                b.on("paste", function (a) {
                    ...
                    if (b.match(/^<[^<]+cke_(editable|contents)/i)) {
                        var g, h, i = new CKEDITOR.dom.element("div");
                        for (i.setHtml(b); 1 == i.getChildCount() && (g = i.getFirst()) && g.type == CKEDITOR.NODE_ELEMENT && (g.hasClass("cke_editable") || g.hasClass("cke_contents"));)i = h = g;
                    ...
                    CKEDITOR.env.ie ? b = b.replace(/^&nbsp;(?: |\r\n)?<(\w+)/g, function (b, e) {
                            ...
                            b = b.replace(/<\/(\w+)><div><br><\/div>$/, function (b, e) {
                                if (e in c) {
                ...
                b.on("paste", function (a) {
                    var a = a.data, e = a.type, f = a.dataValue, g, h = b.config.clipboard_defaultContentType || "html", i = a.dataTransfer.getTransferType(b);
                    g = "html" == e || "html" == a.preSniffing ? "html" : w(f);
                    "htmlifiedtext" == g && (f = x(b.config, f));
                    "text" == e && "html" == g ? f = p(b, f, c.get("plain-text")) : i == CKEDITOR.DATA_TRANSFER_EXTERNAL &&
                        (b.pasteFilter && !a.dontFilter) && (f = p(b, f, b.pasteFilter));
                    a.startsWithEOL && (f = '<br data-cke-eol="1">' + f);
                    a.endsWithEOL && (f += '<br data-cke-eol="1">');
                    "auto" == e && (e = "html" == g || "html" == h ? "html" : "text");
                    a.type = e;
                    a.dataValue = f;
        ...
        CKEDITOR.plugins.clipboard = {
            ...
            fixSplitNodesAfterDrop: function (b, a, c, d) {
                function e(b, c, d) {
                    ...
                    if (e.equals(c) && d != c.getChildCount())return b = a, c = b.startContainer.getChild(b.startOffset -
                ...
                !("number" != typeof d || "number" != typeof c) && (f.type == CKEDITOR.NODE_ELEMENT && !e(b.startContainer, f, c)) && e(b.endContainer, f, d)
            },
            isDropRangeAffectedByDragRange: function (b, a) {
                var c = a.startContainer, d = a.endOffset;
                return b.endContainer.equals(c) && b.endOffset <= d || b.startContainer.getParent().equals(c) &&
                b.startContainer.getIndex() < d || b.endContainer.getParent().equals(c) && b.endContainer.getIndex() < d ? !0 : !1
            },
            internalDrop: function (b, a, c, d) {
                var e = CKEDITOR.plugins.clipboard, f = d.editable(), g, h;
                d.fire("saveSnapshot");
                ...
                (h = this.isDropRangeAffectedByDragRange(b, a)) || (g = b.createBookmark(1));
                e = a.clone().createBookmark(1);
                h && (g = b.createBookmark(1));
                b = d.createRange();
                b.moveToBookmark(g);
                f.extractHtmlFromRange(b, 1);
                a = d.createRange();
                a.moveToBookmark(e);
            ...
            getRangeAtDropPosition: function (b, a) {
                var c = b.data.$, d = c.clientX, e = c.clientY, f = a.getSelection(!0).getRanges()[0], g = a.createRange();
                if (b.data.testRange)return b.data.testRange;
                if (document.caretRangeFromPoint) c = a.document.$.caretRangeFromPoint(d, e), g.setStart(CKEDITOR.dom.node(c.startContainer), c.startOffset), g.collapse(!0);
                else if (c.rangeParent) g.setStart(CKEDITOR.dom.node(c.rangeParent),
                    c.rangeOffset), g.collapse(!0);
                else {
                    if (CKEDITOR.env.ie && 8 < CKEDITOR.env.version && f && a.editable().hasFocus)return f;
                    if (document.body.createTextRange) {
                        ...
                        try {
                            ...
                            if (h) {
                                ...
                                var k = a.document.getById(l);
                                g.moveToPosition(k, CKEDITOR.POSITION_BEFORE_START);
                                k.remove()
                            }
                            else {
                                var n =
                                    a.document.$.elementFromPoint(d, e), o = new CKEDITOR.dom.element(n), p;
                                if (!o.equals(a.editable()) && "html" != o.getName()) p = o.getClientRect(), d < p.left ? g.setStartAt(o, CKEDITOR.POSITION_AFTER_START) : g.setStartAt(o, CKEDITOR.POSITION_BEFORE_END), g.collapse(!0);
                                else return f && f.startContainer && !f.startContainer.equals(a.editable()) ? f : null
                            }
                        }
                        catch (r) {
                            return null
            ...
            initDragDataTransfer: function (b, a) {
                ...
                c ? this.dragData &&
                    d.id == this.dragData.id ? d = this.dragData : this.dragData = d : this.dragData ? d = this.dragData : this.dragData = d;
        ...
        CKEDITOR.plugins.clipboard.dataTransfer = function (b, a) {
            ...
            a && (this.sourceEditor = a, this.setData("text/html",
        ...
        CKEDITOR.plugins.clipboard.dataTransfer.prototype = {
            getData: function (b) {
                ...
                "text/html" == b && CKEDITOR.env.chrome ? (a = a.replace(this._.chromeLinuxRegExp,
                        ""), (b = this._.chromeWindowsRegExp.exec(a)) && 1 < b.length && (a = b[1])) : "Text" == b && (CKEDITOR.env.gecko && this.getFilesCount() && "file://" == a.substring(0, 7)) && (a = "");
                return a
            }, setData: function (b, a) {
                b = this._.normalizeType(b);
                this._.data[b] = a;
                if (CKEDITOR.plugins.clipboard.isCustomDataTypesSupported || !("URL" != b && "Text" != b))try {
                    this.$.setData(b, a)
                }
                catch (c) {
                }
                ...
                if (a = a || r(b)) {
                    ...
                    if (i && k) {
                        if (c && (c.is("li") || c.getParent().is("li"))) {
                            ...
                            if (e.is("li")) h || m ? (h && m && a.remove(), c[m ? "insertAfter" : "insertBefore"](e)) : c.breakParent(e);
                            else {
                                if (b)if (j.block.is("li") ? (e = f.createElement(d == CKEDITOR.ENTER_P ? "p" : "div"), n && e.setAttribute("dir", i), o && e.setAttribute("style", o), k && e.setAttribute("class", k), c.moveChildren(e)) : e = j.block, h || m) e[h ? "insertBefore" : "insertAfter"](a);
                                else c.breakParent(a), e.insertAfter(a);
                                else if (c.appendBogus(!0), h || m)for (; f = c[h ? "getFirst" : "getLast"]();)f[h ? "insertBefore" : "insertAfter"](a);
            ...
            init: function (a) {
                ...
                a.addMode("wysiwyg", function (e) {
                    ...
                    var c = "document.open();" + (CKEDITOR.env.ie ? "(" + CKEDITOR.tools.fixDomain +
                            ")();" : "") + "document.close();", c = CKEDITOR.env.air ? "javascript:void(0)" : CKEDITOR.env.ie ? "javascript:void(function(){" + encodeURIComponent(c) + "}())" : "", d = CKEDITOR.dom.element.createFromHtml('<iframe src="' + c + '" frameBorder="0"></iframe>');
            ...
            base: CKEDITOR.editable, proto: {
                setData: function (a, e) {
                    ...
                    if (e) this.setHtml(a), this.fixInitialSelection(), b.fire("dataReady");
                        ...
                        d ? (/<body[\s|>]/.test(a) || (a = "<body>" + a), /<html[\s|>]/.test(a) || (a = "<html>" + a + "</html>"), /<head[\s|>]/.test(a) ? /<title[\s|>]/.test(a) || (a = a.replace(/<head[^>]*>/, "$&<title></title>")) : a = a.replace(/<html[^>]*>/, "$&<head><title></title></head>"), h && (a = a.replace(/<head[^>]*?>/, "$&" + h)), a = a.replace(/<\/head\s*>/, f + "$&"), a = g + a) : a = c.docType + '<html dir="' + c.contentsLangDirection + '" lang="' + (c.contentsLanguage ||
                                b.langCode) + '"><head><title>' + this._.docTitle + "</title>" + h + f + "</head><body" + (c.bodyId ? ' id="' + c.bodyId + '"' : "") + (c.bodyClass ? ' class="' + c.bodyClass + '"' : "") + ">" + a + "</body></html>";
                    ...
                    this.jobs = {
                        20: {
                            refresh: function (a, b) {
                                ...
                                if (c = a.elementPath().contains(m)) f.call(this, c, d);
                                else {
                                    b = b.createIterator();
                    ...
                    if (b.mode == "wysiwyg" && e in {8: 1, 46: 1}) {
                        ...
                        if (f && f.collapsed) {
                            ...
                            if (i) {
                                ...
                                h = (g = c.getLast(q)) && C(g) ? g : c;
                                c = 0;
                                if ((a = d.next()) && a.type == CKEDITOR.NODE_ELEMENT && a.getName() in r && a.equals(g)) {
                                    c = 1;
                                    a = d.next()
                                }
                                else f.checkBoundaryOfElement(h, CKEDITOR.END) && (c = 2);
                                if (c && a) {
                                    f = f.clone();
        ...
        if (!0 === CKEDITOR.config.scayt_handleCheckDirty) {
            ...
            a.checkDirty = CKEDITOR.tools.override(a.checkDirty, function (a) {
                return function () {
                    ...
                    else if (b = "ready" == this.status)var e = c.removeMarkupFromString(this.getSnapshot()), c = c.removeMarkupFromString(this._.previousValue), b = b && c !== e;
                    return b
                }
            });
