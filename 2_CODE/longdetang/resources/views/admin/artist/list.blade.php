...
@section('content')
    ...
    @endpush
    @push('scripts')
        <script src="{{asset('/assets/js/page/artist/list.js')}}">
        </script>
    @endpush
    <div class="ibox ">
        <div class="ibox-title">
            <h5><i class="fa fa-filter"></i>&nbsp;&nbsp;艺人列表</h5>
        </div>
                ...
                <div class="row">
                    <div class="col-md-3">
                        ...
                        <div class="form-value">
                            <input type="text" class="form-control" name="name" value="{{$title or ''}}" placeholder="请输入艺人名称">
                        </div>
                    </div>
